...
The enumeration is deterministic, exact, and reproducible; the program and full per-\(G\) JSON are archived at \href{empirical/paper34_C4_noncyclic_certificate.py}{\texttt{empirical/noncyclic\_certificate.py}} and \href{empirical/reports/paper34_C4_noncyclic_summary.md}{\texttt{empirical/reports/noncyclic\_summary.md}}. On every candidate the certificate holds: Fisher block-diagonality is exact, and the cross-packet AC cubic triple count is strictly positive.
